...
grammar['{block}.n'] = lambda x: NArg(obj_type = x)
grammar['table.n'] = lambda x: NArg(obj_type = 'table', obj_id = "TABLE")
grammar['|table|.n'] = lambda x: NArg(obj_type = 'table', obj_id = "TABLE")
grammar['|construction area|.n'] = lambda x: NArg(obj_type = 'construction_area', obj_id = "CONSTRUCTION AREA")
grammar['|construction_area|.n'] = lambda x: NArg(obj_type = 'construction_area', obj_id = "CONSTRUCTION AREA")
grammar['|construction area|'] = lambda x: NArg(obj_type = 'construction_area', obj_id = "CONSTRUCTION AREA")
grammar['|construction_area|'] = lambda x: NArg(obj_type = 'construction_area', obj_id = "CONSTRUCTION AREA")
...
grammar['toyota'] = lambda x: TName(x)
grammar['mcdonalds'] = lambda x: TName(x)
grammar['mcdonald\'s'] = lambda x: TName(x)
grammar['sri'] = lambda x: TName(x)
grammar['starbucks'] = lambda x: TName(x)
grammar['texaco'] = lambda x: TName(x)
grammar['target'] = lambda x: TName(x)
...
grammar['|mcdonald\'s|.n'] = lambda x: TName(x)
...
grammar[("NPred", "NColor")] = lambda x, y: NPred(content = y.content, children = x.children, neg = x.neg, mods = x.mods)
